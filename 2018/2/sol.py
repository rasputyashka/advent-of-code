inp = """qywzphxoiseldjrbaoagvkmanu
...
pairs = [('qywephxoiseldjrbthcgvkmane', 'qywhphxoiseldjrbtccgvkmane'),
('qywzehxoiseldfrbtpcgvkmanu', 'qywzphxoiseldvrbtftgckmanu'),
('qywzphxoiseldjrntfygvdmanu', 'qyszphxoiseldjrntfygvdmanu'),
('qywhphxoiseldjrbtccgvkmane', 'qywlphxoisehdjrbtfcgvkmanc'),
('hywzphxoiseldjrbtfcuvkmanc', 'sywzphxoiseldjrbhfccvkmanu')]


for pair in pairs:
    for a in range(len(pair[0])):
